...
const AboutSection: FC = () => {
  ...
  <CardBody className="bg-gradient-to-br from-blue-500 to-blue-900 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
    ...
    >
      StoryVerse is a collaborative storytelling platform that enables users to co-create, share, and interact with dynamic narratives in real-time.
    </CardItem>
    <CardItem
      translateZ="100"
      rotateX={20}
      ...
      Liked it ❤️
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            MongoDB, Nextjs, Typescript, Redis, Tailwind, HTML, CSS, Git and Docker. I am a quick learner and I am always
